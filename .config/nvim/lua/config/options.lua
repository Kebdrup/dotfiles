...
vim.keymap.set("n", "<Leader>r", vim.lsp.buf.rename, { desc = "Rename across files" })
vim.keymap.set("n", "<Leader>k", "<C-]>", { desc = "Jump to tag" })
vim.keymap.set("n", "<Leader>j", "<CMD>pop<CR>", { desc = "Go back a tag" })
